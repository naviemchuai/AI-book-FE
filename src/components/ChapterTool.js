import { BookmarkIcon, ChatBubbleLeftRightIcon, SpeakerWaveIcon } from '@heroicons/react/20/solid'
...
export default function ChapterTool() {
  return (
    <span className="mt-4 isolate inline-flex rounded-md shadow-sm">
      ...
      >
        <ChatBubbleLeftRightIcon className="-ml-0.5 h-5 w-5 text-gray-400" aria-hidden="true" />
        AI Chat
      </button>
      <button
        type="button"
